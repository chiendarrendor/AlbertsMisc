...
# $class->Depth() -- this routine will return a number representing
#    how many steps it took to get to this state.
...
sub ByGrade 
{ 
    return $b->{GRADE} <=> $a->{GRADE} if $b->{GRADE} != $a->{GRADE};
